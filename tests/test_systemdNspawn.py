...
def debian_bootstrap():
    ...
    debian_path = os.environ.get("DEBIAN_PATH","/home/odair/projects/seren/fixtures_data/debian")
...
@pytest.mark.parametrize(
        ...
        [
            ("debian_bootstrap","ls -a | md5sum", 0, "c4f0ad5e4284f6ec45145036561adf11  -\n"),
            ("archlinux_bootstrap","ls -a | md5sum", 0, "d41d8cd98f00b204e9800998ecf8427e  -\n"),
            ("debian_bootstrap","apt install neovim -y &> /dev/null",0,""),
            pytest.param("archlinux_bootstrap", "command_not_found",1,"", marks=pytest.mark.xfail),
            ]

        )

def test_SystemdNspawn_runner(bootstrap,command,expected_return_value,expected_output,request):
